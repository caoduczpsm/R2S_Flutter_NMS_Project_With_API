              ...
              children: [
                ...
                ElevatedButton(
                    onPressed: () async {
                      ...
                      if (category == null) {
                        NoteData? result = await categoryCubit.createCategory(
                          email,
                          nameController.text,);
                        if (result != null) {
          ...
          actions: [
            ...
            TextButton(
              onPressed: () async {
                ...
                NoteData? result = await categoryCubit.deleteCategory(email, category[0]);
                if(result != null) {
                  if(result.status == 1) {
                    categoryCubit.getAllData(email);
                      ...
                      return Padding(
                          ...
                          child: ListView.builder(
                              ...
                              itemBuilder: (context, index) => Dismissible(
                                ...
                                child: buildListCard(category[index], index),
                              )));
